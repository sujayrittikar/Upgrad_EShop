...
export default function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    const firstNameVal = data.get('firstName');
    const lastNameVal = data.get('lastName');
    const passwordVal = data.get('password');
    const emailVal = data.get('email');
    const contactVal = data.get('contact');
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  autoComplete="email"
                  value={email}
                  inputProps={{ maxLength: 255, minLength: 5 }}
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  value={password}
                  inputProps={{ maxLength: 1024, minLength: 5 }}
